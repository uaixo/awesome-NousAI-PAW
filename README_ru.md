...
- [2026-08-13] **v2.1.0** | NousAIPaw OS Shell, единое файловое пространство, NousAIPaw Creator, интеграция агентов Codex/Qoder, Browser-use, Computer-use, контрольные точки и продолжение длительных задач в диалоге. [Release Notes v2.1.0 →](https://qwenpaw.agentscope.io/release-notes#v2.1.0)
...
| **Приложения NousAIPaw**                          | NousAIPaw Insight                                | В работе        |
|                                                 | NousAIPaw Mail                                   | В работе        |
