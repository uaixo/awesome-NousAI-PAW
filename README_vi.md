...
- [2026-08-13] **v2.1.0** | NousAIPaw OS Shell, không gian làm việc Files hợp nhất, NousAIPaw Creator, tích hợp agent Codex/Qoder, Browser-use, Computer-use, điểm khôi phục workspace và tiếp tục tác vụ hội thoại dài. [Ghi chú phát hành v2.1.0 →](https://qwenpaw.agentscope.io/release-notes#v2.1.0)
...
| **Ứng dụng NousAIPaw**           | NousAIPaw Insight                               | Đang thực hiện        |
|                                | NousAIPaw Mail                                  | Đang thực hiện        |
